/// Provides public:
/// 1. [Web3Ethereum]
/// 2. [Web3EthereumWalletTypes]
library web3_ethereum;

import 'package:js/js.dart';
import 'package:js/js_util.dart';
import 'package:web3_ethereum/wallet_types.dart';
...
class Web3Ethereum {
  ...
  Future<T> request<T>(String method, {List? params}) async {
    return promiseToFuture(_ethereum.request(_RequestArguments(
      method: method,
